...
export const translations = {
  en: {
    ...
    demo: {
      ...
      // Validated CBT biases for demo
      catastrophizing: 'Catastrophizing',
      procrastination: 'Procrastination',
      allOrNothingThinking: 'All-or-Nothing Thinking',
      keyInsight: 'Key insight',
      insightText: "Tendency toward 'what if' spirals and avoidance patterns.",
    ...
    dashboard: {
      ...
      // 11 validated CBT biases from cognitive-bias-framework.ts
      allOrNothingThinking: 'All-or-Nothing Thinking',
      allOrNothingThinkingDesc: 'Viewing situations in only two categories rather than on a continuum.',
      catastrophizing: 'Catastrophizing',
      catastrophizingDesc: "Expecting the worst; 'what if' spirals that escalate into predictions of disaster.",
      mindReading: 'Mind Reading',
      mindReadingDesc: 'Assuming you know what others are thinking without evidence.',
      shouldStatements: 'Should Statements',
      shouldStatementsDesc: "Rigid expectations using 'should', 'must', 'have to' that create pressure.",
      emotionalReasoning: 'Emotional Reasoning',
      emotionalReasoningDesc: 'Treating feelings as evidence about reality.',
      overgeneralization: 'Overgeneralization',
      overgeneralizationDesc: 'Drawing broad conclusions from single events.',
      personalization: 'Personalization',
      personalizationDesc: 'Taking excessive blame for things outside your control.',
      filtering: 'Filtering',
      filteringDesc: 'Focusing only on negatives while ignoring positives.',
      fortuneTelling: 'Fortune Telling',
      fortuneTellingDesc: 'Predicting negative outcomes with false certainty.',
      labeling: 'Labeling',
      labelingDesc: 'Defining self or others with global negative labels.',
      procrastination: 'Procrastination',
      procrastinationDesc: 'Avoidance of tasks due to emotional dysregulation, perfectionism, or fear of failure.',
  ...
  fr: {
    ...
    demo: {
      ...
      // Biais CBT valides pour la demo
      catastrophizing: 'Catastrophisation',
      procrastination: 'Procrastination',
      allOrNothingThinking: 'Pensee tout-ou-rien',
      keyInsight: 'Insight cle',
      insightText: "Tendance aux spirales 'et si' et aux schemas d'evitement.",
    ...
    dashboard: {
      ...
      // 11 biais CBT valides de cognitive-bias-framework.ts
      allOrNothingThinking: 'Pensee tout-ou-rien',
      allOrNothingThinkingDesc: 'Voir les situations en deux categories extremes plutot que sur un continuum.',
      catastrophizing: 'Catastrophisation',
      catastrophizingDesc: "S'attendre au pire; spirales de 'et si' qui escaladent en predictions de desastre.",
      mindReading: 'Lecture de pensees',
      mindReadingDesc: 'Supposer savoir ce que les autres pensent sans preuves.',
      shouldStatements: 'Injonctions du devoir',
      shouldStatementsDesc: "Attentes rigides utilisant 'je devrais', 'je dois' qui creent de la pression.",
      emotionalReasoning: 'Raisonnement emotionnel',
      emotionalReasoningDesc: 'Traiter les sentiments comme des preuves de la realite.',
      overgeneralization: 'Surgeneralisation',
      overgeneralizationDesc: "Tirer des conclusions larges a partir d'evenements isoles.",
      personalization: 'Personnalisation',
      personalizationDesc: "S'attribuer une responsabilite excessive pour des choses hors de son controle.",
      filtering: 'Filtrage',
      filteringDesc: 'Se concentrer uniquement sur le negatif en ignorant le positif.',
      fortuneTelling: 'Prediction negative',
      fortuneTellingDesc: 'Predire des resultats negatifs avec une fausse certitude.',
      labeling: 'Etiquetage',
      labelingDesc: 'Se definir ou definir les autres avec des etiquettes negatives globales.',
      procrastination: 'Procrastination',
      procrastinationDesc: "Evitement des taches du a une dysregulation emotionnelle, au perfectionnisme ou a la peur de l'echec.",
